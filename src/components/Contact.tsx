    ...
    <section id="contact" className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="border border-gray-600 hover:border-gray-400 text-gray-300 hover:text-white font-semibold px-6 py-3 rounded-lg transition-colors text-center"
        >
          GitHub
        </a>
      </div>
